...
online version: https://docs.microsoft.com/powershell/module/az.connectedvmware/new-azconnectedvmwarevnet
schema: 2.0.0
---
...
```
New-AzConnectedVMwareVNet -Name <String> -ResourceGroupName <String> -JsonFilePath <String>
...
### CreateViaJsonString
```
New-AzConnectedVMwareVNet -Name <String> -ResourceGroupName <String> -JsonString <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
