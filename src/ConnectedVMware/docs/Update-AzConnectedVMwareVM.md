...
```powershell
Update-AzConnectedVMwareVM -Name "test-vm" -ResourceGroupName "test-rg" -SubscriptionId "204898ee-cd13-4332-b9d4-55ca5c25496d" 
-Tag @{"vm"="test"}
```
...
This command update tag of a VM named `test-vm` in a resource group named `test-rg`.
...
This command update Memory Size of a VM named `test-vm` in a resource group named `test-rg`.

### Example 2: Update Virtual Machine Resource Identity Type
```powershell
Update-AzConnectedVMwareVM -Name "test-vm" -ResourceGroupName "test-rg" -SubscriptionId "204898ee-cd13-4332-b9d4-55ca5c25496d" -IdentityType "SystemAssigned"
```
...
This command update Identity Type of a VM named `test-vm` in a resource group named `test-rg`.
